...
<div id="voteManage" class="box">
	<h2>添加新投票(投票默认时间10天，如果您想修改，请点击维护)</h2>
	<div class="content">
	<form method="post" action="${pageContext.request.contextPath}/m/doAdd.do">
			<dl>
				<dt>投票内容：</dt>
				<dd>
				...
				<dt>投票类型：</dt>
				<dd>
		  		   <input type="radio" name="number" <c:if test="${subject.number==1 }"> checked="checked" </c:if>checked="checked" value="1" />单选
				...
				<dd class="button">
					...
					<a href="${pageContext.request.contextPath }/list.do">取消操作</a>
				</dd>
			</dl>
		</form>
