		...
		<div class="login">
			...
			<form method="post" action="${pageContext.request.contextPath }/doLogin.do">
				<dl id="loginBox">
					...
					<dt></dt>
					<dd><input type="checkbox"  name="remember" <c:if test="${user.remember }"> checked="checked" </c:if>value="1"/>10天内免登录</dd>
					<dt></dt>
					<dd><input type="submit" class="input-button" name="submit" value="登录" /> <a href="${pageContext.request.contextPath }/reg.do">新用户注册</a></dd>
				</dl>
			</form>
